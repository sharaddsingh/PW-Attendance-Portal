...
import PhotoVerification from "../components/faculty/PhotoVerification";
import AttendanceReports from "../components/faculty/AttendanceReports";
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center">
                <Presentation className="w-6 h-6 text-white" /> {/* ✅ fixed */}
              </div>
              <div>
