...
import { getFirestore, doc, setDoc, getDoc, collection, addDoc, query, where, orderBy, onSnapshot, updateDoc, deleteDoc, getDocs } from 'firebase/firestore';
...
const firebaseConfig = {
  ...
  storageBucket: "attendancetracker-f8461.firebasestorage.app",
  messagingSenderId: "87952419692",
  appId: "1:87952419692:web:6ca63cb53cc467be972149",
  measurementId: "G-Z02VVKYQ07"
};
  ...
  try {
    ...
    if (attendanceData.sessionId) {
      ...
      if (sessionDoc.exists()) {
        ...
        if (!studentsPresent.some(s => s.studentId === attendanceData.studentId)) {
...
export const getActiveSessions = async (facultyId) => {
  try {
    ...
    snapshot.forEach(doc => {
      const data = doc.data();
      const now = new Date();
      const expiresAt = data.expiresAt?.toDate() || new Date(data.createdAt.toDate().getTime() + 30000);
...
export const academicDataService = {
  ...
  initializeAcademicData: async () => {
    try {
      ...
      // Create Batches
      const batches = [
        { id: 'sot24b1', name: 'SOT 2024 Batch 1', schoolId: 'sot', year: 2024, semester: 1 },
        { id: 'sot24b2', name: 'SOT 2024 Batch 2', schoolId: 'sot', year: 2024, semester: 2 },
        { id: 'sot23b1', name: 'SOT 2023 Batch 1', schoolId: 'sot', year: 2023, semester: 1 },
        { id: 'som23b1', name: 'SOM 2023 Batch 1', schoolId: 'som', year: 2023, semester: 1 },
        { id: 'som24b1', name: 'SOM 2024 Batch 1', schoolId: 'som', year: 2024, semester: 1 }
      ];
      ...
      const subjects = [
        ...
        { id: 'javascript', name: 'JavaScript', schoolId: 'sot', code: 'CS301' },
